...
*/
/**************************************************************************/
boolean Adafruit_VL6180X::begin(uint8_t I2C_ADDR) {
  _i2caddr = VL6180X_DEFAULT_I2C_ADDR;
  Wire.begin(); 
  
  write8(0x0212, I2C_ADDR);  // write new address to the sensor
  _i2caddr = I2C_ADDR;       // save new address to global variable
